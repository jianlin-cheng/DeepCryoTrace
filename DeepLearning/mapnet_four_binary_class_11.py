...
model = Sequential()
model.add(Conv3D(10, kernel_size=(3,3,3), activation='relu', input_shape=(11,11,11,1), padding='same'))
...
model.add(Conv3D(48, kernel_size=(3,3,3), activation='relu', padding='valid'))
